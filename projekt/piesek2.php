...
if(isset($_POST['wplac']))
{
    ...
    $rezultat = $polaczenie->query("SELECT adopcja FROM pieski WHERE id = '3'");
    ...
    if($numer=='0')
    {
        ...
        {
        //pierwszy piesek
            $_SESSION['imie']=$pieski[2][1];
            $_SESSION['wiek']=$pieski[2][2];
            $_SESSION['gatunek']=$pieski[2][3];
            $_SESSION['odkiedy']=$pieski[2][4];
            if(isset($_POST['adopt']))
    {
        $rezultat3 = $polaczenie->query("UPDATE pieski SET adopcja = '1' WHERE id = '3'");
...
<nav>
    ...
    <div class="kontener">
    <img src="img/pies_schron2.jpg" alt="Latek">
            <div class="info">
