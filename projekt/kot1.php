...
if(isset($_POST['wplac']))
{
    ...
    $rezultat = $polaczenie->query("SELECT adopcja FROM pieski WHERE id = '5'");
    ...
    if($numer=='0')
    {
        ...
        {
        //pierwszy piesek
            $_SESSION['imie']=$pieski[4][1];
            $_SESSION['wiek']=$pieski[4][2];
            $_SESSION['gatunek']=$pieski[4][3];
            $_SESSION['odkiedy']=$pieski[4][4];
            if(isset($_POST['adopt']))
    {
        $rezultat3 = $polaczenie->query("UPDATE pieski SET adopcja = '1' WHERE id = '5'");
...
<nav>
    ...
    <div class="kontener">
    <img src="img/kot_schron1.jpg" alt="Latek">
            <div class="info">
