...
if(isset($_POST['wplac']))
{
    ...
    $rezultat = $polaczenie->query("SELECT adopcja FROM pieski WHERE id = '2'");
    ...
    if($numer=='0')
    {
        ...
        {
        //pierwszy piesek
            $_SESSION['imie']=$pieski[1][1];
            $_SESSION['wiek']=$pieski[1][2];
            $_SESSION['gatunek']=$pieski[1][3];
            $_SESSION['odkiedy']=$pieski[1][4];
            if(isset($_POST['adopt']))
    {
        $rezultat3 = $polaczenie->query("UPDATE pieski SET adopcja = '1' WHERE id = '2'");
...
<nav>
    ...
    <div class="kontener">
    <img src="img/pies_schron1.jpg" alt="Latek">
            <div class="info">
