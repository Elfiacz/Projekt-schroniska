...
if(isset($_POST['wplac']))
{
    ...
    $rezultat = $polaczenie->query("SELECT adopcja FROM pieski WHERE id = '4'");
    ...
    if($numer=='0')
    {
        ...
        {
        //pierwszy piesek
            $_SESSION['imie']=$pieski[3][1];
            $_SESSION['wiek']=$pieski[3][2];
            $_SESSION['gatunek']=$pieski[3][3];
            $_SESSION['odkiedy']=$pieski[3][4];
            if(isset($_POST['adopt']))
    {
        $rezultat3 = $polaczenie->query("UPDATE pieski SET adopcja = '1' WHERE id = '4'");
...
<nav>
    ...
    <div class="kontener">
    <img src="img/kon_schron1.jpg" alt="Latek">
            <div class="info">
